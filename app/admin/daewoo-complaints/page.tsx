          ...
          {['all', 'bus_delay', 'staff_behavior', 'ticket_issue', 'refund', 'luggage', 'other'].map(t => (
            <button
              ...
              className={`text-xs px-2 py-0.5 rounded-md transition-all ${
                filterType === t ? 'bg-white/20 text-white font-medium' : 'text-gray-400 hover:text-white'
              }`}
            >
        ...
        <div className="flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-lg px-3 py-1.5">
          ...
          {['all', 'complaint_filed', 'caller_disconnected', 'transferred_to_human'].map(o => (
            <button
              ...
              className={`text-xs px-2 py-0.5 rounded-md transition-all ${
                filterOutcome === o ? 'bg-white/20 text-white font-medium' : 'text-gray-400 hover:text-white'
              }`}
            >
